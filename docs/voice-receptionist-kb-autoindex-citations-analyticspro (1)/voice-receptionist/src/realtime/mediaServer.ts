  ...
  wss.on('connection', async (twilioWS: WebSocket) => {
    ...
    function flushInput() {
      ...
      openaiWS.send(JSON.stringify({
        ...
        response: { modalities: ['text', 'audio'], instructions: 'You are a helpful receptionist. Use tools when appropriate. When using the answerQuestion tool, summarize clearly and include a brief spoken citation like: "Source: <top source>" at the end.' }
      }));
    }
